...
@section('content')
<!-- Hero Banner -->
<section data-section-id="{{ $sections->where('section_key', 'about_hero')->first()->id ?? '97' }}" data-section-key="about_hero" data-section-label="About Hero" class="bg-gradient-to-r from-ink to-ink2 text-white py-24 px-4 md:px-8 border-b-4 border-teal @auth cms-editable @endauth" data-cms-label="Edit About Hero">
...
<!-- Our Story / Mission -->
<section data-section-id="{{ $sections->where('section_key', 'about_content')->first()->id ?? '98' }}" data-section-key="about_content" data-section-label="Mission & Story" class="py-20 px-4 md:px-8 max-w-[1000px] mx-auto text-center sr-up @auth cms-editable @endauth" data-cms-label="Edit Mission & Story">
...
<!-- Values Cards -->
<section data-section-id="{{ $sections->where('section_key', 'about_content')->first()->id ?? '98' }}" data-section-key="about_content" data-section-label="Core Values" class="bg-bg py-24 px-4 md:px-8 border-y border-line @auth cms-editable @endauth" data-cms-label="Edit Core Values">
...
<!-- Why Choose Us -->
<section data-section-id="{{ $sections->where('section_key', 'about_content')->first()->id ?? '98' }}" data-section-key="about_content" data-section-label="The Advantage" class="py-24 px-4 md:px-8 max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center @auth cms-editable @endauth" data-cms-label="Edit Advantage">
...
<!-- Trust Stats -->
<section data-section-id="{{ $sections->where('section_key', 'about_content')->first()->id ?? '98' }}" data-section-key="about_content" data-section-label="Trust Stats" class="bg-ink py-16 px-4 md:px-8 border-t border-line text-white @auth cms-editable @endauth" data-cms-label="Edit Trust Stats">
