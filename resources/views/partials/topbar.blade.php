<div class="bg-ink text-[#4a6080] font-mono text-[10px] tracking-[1.5px] py-2 px-4 md:px-8 flex justify-between items-center whitespace-nowrap overflow-hidden">
    <div class="flex items-center space-x-6">
        <a href="mailto:{{ $globalSettings['email_info'] ?? 'info@novasynchem.com' }}" class="hover:text-teal-2 transition-colors">{{ $globalSettings['email_info'] ?? 'info@novasynchem.com' }}</a>
