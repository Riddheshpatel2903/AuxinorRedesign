...
<div class="space-x-4">
    ...
    <a href="{{ route('insights.show', $post->slug) }}" target="_blank" class="text-teal hover:text-white transition-colors font-mono text-[11px] uppercase tracking-wider">
        View Live ↗
    </a>
    @endif
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="admin-card p-6 md:p-8">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="slug" value="{{ old('slug', $post->slug) }}" class="admin-input w-full p-3 font-mono text-[13px] text-white/70">
            ...
            <div class="admin-card p-6">
                ...
                <div class="mb-6">
                    ...
                    @if($post->featured_image)
                        <img src="{{ $post->featured_image }}" class="mt-2 w-full h-24 object-cover border border-white/10 opacity-70">
                    @endif
                </div>
                ...
                <div class="space-y-4 mb-8">
                    <label class="flex items-center space-x-3 cursor-pointer">
                        <input type="checkbox" name="is_published" value="1" {{ old('is_published', $post->is_published) ? 'checked' : '' }} class="w-4 h-4 text-teal bg-ink border-white/20 rounded">
                        <span class="font-serif text-[14px] text-white">Live Publication</span>
                    </label>
                </div>
